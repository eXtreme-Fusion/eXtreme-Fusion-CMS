...
if ($rows)
{
	...
	foreach($cache as &$news)
	{
		...
		{
			throw new systemException('Błąd! Użytkownik posiada w cache\'u materiału, do którego nie ma uprawnień. Czyszczenie cache\'u przy edycji newsa nie działa poprawnie.');
		}
	}
