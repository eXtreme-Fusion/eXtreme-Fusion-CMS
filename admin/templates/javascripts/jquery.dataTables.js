	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Pokaż _MENU_ elementów",
				"sZeroRecords": "Brak pasujących rekordów",
				"sEmptyTable": "Brak danych",
				"sInfo": "Pokazywane _START_ do _END_ z _TOTAL_ elementów",
				"sInfoEmpty": "Pokazywane 0 do 0 z 0 elementów",
				"sInfoFiltered": "(z _MAX_ wszystkich elementów)",
				"sInfoPostFix": "",
				"sSearch": "Szukaj:",
				"sUrl": "",
				"oPaginate": {
			 ...
			 */
			this.aLengthMenu = [25, 50, 100, 150, 200, 250, 300 ];
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select size="1" '+sName+' class="nice">';
			var i, iLen;
