...
class Theme extends optClass
{
	...
	public function showCopyright($license = FALSE, $class = FALSE) 
	{
		if ($license)
		{
			return __('Powered by :system under :license License', array(':system' => '<a href="http://extreme-fusion.org/"'.($class ? ' class="'.$class.'"' : '').' rel="copyright">eXtreme-Fusion</a>', ':license' => '<a href="http://extreme-fusion.org/ef5/license/"'.($class ? ' class="'.$class.'"' : '').' rel="copyright">BSD</a>'))."\n";
		}
		
		return __('Powered by :system', array(':system' => '<a href="http://extreme-fusion.org/"'.($class ? ' class="'.$class.'"' : '').' rel="copyright">eXtreme-Fusion</a>'))."\n";
	}
