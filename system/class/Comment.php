...
class Comment extends Observer
{
	...
	// Ilość dni, przez które komentarze moga znajdować się w bazie
	...
	// ID komentarza, treść, czas zapisu, autor (nick)
	...
	// Dodaje do bazy komentarz uprzednio sprawdzając, czy uzytkownik ma prawo do zamieszczania komentarzy
	// Dane wejściowe nie są przefiltrowane
	// Metoda przeznaczona do żądań AJAX - nie rzuca wyjątkami, a jedynie zwraca wartość
