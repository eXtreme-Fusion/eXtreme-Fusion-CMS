...
{panel=i18n('Edit account')}
	...
	<form action="{$URL_REQUEST}" method="post" enctype="multipart/form-data" name="account">
		...
		<div class="tbl1">
			<div class="formLabel grid_3"><label for="avatar">{i18n('Avatar:')}</label><small>{i18n('Avatar requirements', array(':filesize' => $avatar_filesize, ':width' => $avatar_width, ':height' => $avatar_height))}</small></div>
			<div class="formField grid_7">
