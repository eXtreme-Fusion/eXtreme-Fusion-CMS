...
{panel=i18n('Edit account')}
	...
	<form action="{$URL_REQUEST}" method="post" enctype="multipart/form-data" name="account">
		...
		{else}
		<div class="tbl1">
			<div class="formLabel grid_4"><label>{i18n('Username:')}</label></div>
			<div class="formField grid_7"><strong>{$user.username}</strong></div>
		</div>
		{/if}
		<div class="tbl2">
			<div class="formLabel grid_4"><label for="old_password">{i18n('Current password:')}<sup>*</sup></label></div>
			<div class="formField grid_7"><input type="password" name="old_password" id="old_password" class="long_textbox"></div>
		</div>
		<div class="tbl1">
			<div class="formLabel grid_4"><label for="new_password">{i18n('New password:')}</label></div>
			<div class="formField grid_7"><input type="password" name="password1" id="new_password"></div>
		</div>
		<div class="tbl2">
			<div class="formLabel grid_4"><label for="confirm_password">{i18n('Confirm new password:')}</label></div>
			<div class="formField grid_7"><input type="password" name="password2" id="confirm_password"></div>
		</div>
		<div class="tbl1">
			<div class="formLabel grid_4"><label for="email">{i18n('E-mail address:')}</label></div>
			<div class="formField grid_7"><input type="text" name="email" value="{$user.email}" id="email"></div>
		</div>
		<div class="tbl2">
			<div class="formLabel grid_4"><label>{i18n('Hide e-mail:')}</label></div>
		...
		<div class="tbl1">
			<div class="formLabel grid_4"><label for="avatar">{i18n('Avatar:')}</label></div>
			<div class="formField grid_7">
		...
		<div class="tbl2">
			<div class="formLabel grid_4"><label for="theme">{i18n('Theme:')}</label></div>
			<div class="formField grid_7">
		...
		<div class="tbl1">
			<div class="formLabel grid_4"><label for="language">{i18n('Language:')}</label></div>
			<div class="formField grid_7">
		...
		{section=fields}
		<div class="tbl2">
			<div class="formLabel grid_4"><label for="{$fields.label}">{i18n($fields.name)}:</label></div>
			{if $fields.type == 1}
			<div class="formField grid_7">
