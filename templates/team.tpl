		...
		{if $admin}
			...
			{section=admin}
				<div class="team tbl2">
					...
					<div class="team-avatar">
						{if $admin.avatar}
							<img src="{$ADDR_IMAGES}avatars/{$admin.avatar}" alt="Avatar" class="avatar">
						{else}
							<img src="{$ADDR_IMAGES}avatars/none.gif" alt="No Avatar" class="avatar">
						{/if}
					</div>
					...
					{section}
						<div class="team tbl2">
							...
							<div class="team-info tbl2">
								...
								<div><strong>{i18n('Last Visit')}:</strong>{if $users.is_online == 1}{i18n('Online')}<img src="{$ADDR_IMAGES}profile/online.png" alt="{i18n('Online')}">{else}{$users.last_visit_time}<img src="{$ADDR_IMAGES}profile/offline.png" alt="{i18n('Offline')}">{/if}</div>
